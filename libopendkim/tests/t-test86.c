...
#define BADFROM		"From: \"Foo \"BAR Baz\" <notification+zj4o9cjf409y@example.com>"
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple check for proper From syntax\n");
	...
	status = dkim_header(dkim, BADFROM, strlen(BADFROM));
